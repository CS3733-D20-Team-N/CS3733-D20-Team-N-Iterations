...
public class DynamicBeat extends JFrame {
  ...
  private ImageIcon backButtonBasicImage =
      new ImageIcon(Main.class.getResource("../images/backButtonBasic.png"));

  private Image background =
      new ImageIcon(Main.class.getResource("../images/introBackground(Title).jpg")).getImage();
  ...
  public DynamicBeat() {
    ...
    menuBar.addMouseMotionListener(
  ...
  public void selectTrack(int nowSelected) {
    ...
    titleImage =
        new ImageIcon(
                Main.class.getResource("../images/" + trackList.get(nowSelected).getTitleImage()))
            .getImage();
    selectedImage =
        new ImageIcon(
                Main.class.getResource("../images/" + trackList.get(nowSelected).getStartImage()))
            .getImage();
  ...
  public void gameStart(int nowSelected, String difficulty) {
    ...
    background =
        new ImageIcon(
                Main.class.getResource("../images/" + trackList.get(nowSelected).getGameImage()))
            .getImage();
    ...
    game =
        new Game(
            trackList.get(nowSelected).getTitleName(),
            difficulty,
